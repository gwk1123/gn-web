...
import com.gn.web.manual.entity.BaseAirRoute;
import com.gn.web.manual.service.BaseAirRouteService;
...
public class BaseAirRouteController {
    ...
    public BaseAirRouteController(BaseAirRouteService aseAirRouteService) {
        this.aseAirRouteService = aseAirRouteService;
    }
